...
fecha: 19 mayo 2021
resumen: lectura y carga en array bidimensional de un XML usando fetch()
...
function controlar(){
	...
	function validarXML() {
		...
		// lee desde GitHub para evitar CORS
		
		var url = "https://carlosboniniklison.github.io/publico/ejercicios/xml/registrados.xml";
