...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/mi-bootstrap.css')}}">
</head>
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-9">
                <form action="{{route('videojuegos.update',['videojuego' => $videojuego -> id])}}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    @csrf
